...
AEnemy::AEnemy()
{
	...
	// Not a good idea to call it inside the constructor
	//CombatCollision->AttachToComponent(GetMesh(), FAttachmentTransformRules::SnapToTargetIncludingScale, FName("EnemySocket"));
	// Hence the below alternative
...
void AEnemy::MoveToTarget(AMain* Target)
{
	...
	if (AIController)
	{
		...
		// Debug spheres for tracing the path points the AI takes
	...
	if (Alive() && bHasValidTarget)
	{
		...
		if (!bAttacking)
		{
			...
			if (AnimInstance && CombatMontage)
			{
				...
				//UE_LOG(LogTemp, Warning, TEXT("Return value is : %f"), MontageReturnValue);
			}
			if (SwingSound)
			{
...
void AEnemy::Die(AActor* DmgCauser)
{
	...
	AMain* Main = Cast<AMain>(DmgCauser);
	if (Main)
	{
		Main->UpdateCombatTarget();
	}
